...
export const perDiemRates: PerDiemRate[] = [
  ...
  { country: 'Norwegen', countryCode: 'NO', fullDay: 70, partialDay: 47 },
  ...
  { country: 'Schweiz', countryCode: 'CH', fullDay: 66, partialDay: 44 },
  ...
  // Americas
  { country: 'USA', countryCode: 'US', fullDay: 60, partialDay: 40 },
  ...
  { country: 'Südkorea', countryCode: 'KR', fullDay: 56, partialDay: 37 },
